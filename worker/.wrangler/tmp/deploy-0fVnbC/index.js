...
var AIService = class {
  ...
  async getAISettings(db, env, userId) {
    ...
    for (const row of rows) {
      ...
      settings2[row.key] = value;
    }
    return {
      apiBase: env.OPENAI_API_BASE || settings2.OPENAI_API_BASE || "https://api.openai.com/v1",
      apiKey: env.OPENAI_API_KEY || settings2.OPENAI_API_KEY || "",
      model: env.AI_MODEL_NAME || settings2.AI_MODEL_NAME || "gpt-3.5-turbo"
    };
  }
  /**
